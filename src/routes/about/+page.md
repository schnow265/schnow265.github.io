...
I started with **Java** from Minecraft modding (_mainly FabricMC_), and since then, I have explored other languages and gained knowledge and skills. Some of my Skills are knowledge in the Console Scripts **sh** and **pwsh**. I gained these because I am using currently _GNU/Linux_.
...
But there is a problem with my Fedora Usage: I liked to break it. Once I removed the _entirety_ of the pip-Folder to free up space. As a note, **dnf**, the package Manager of Fedora, is made in Python. And I couldn't just type _pip install dnf_, because it said that I need to install the package **python3-dnf** via the systems package manager. So, how often did I reinstall it?
...
|5 |KDE Spin |06.08.2023|Knowledge made from _The Budgie Experiment_: I HATE BUDGIE! EXPLORER: CRAPPY. STRUCTURE OF SETTINGS: F-ING GNOME! |
