import{s as w,n as k,e as x}from"../chunks/scheduler.k-kUyWhY.js";import{S as C,i as R,g as E,m as o,h as y,j as $,n as i,f as h,l as T,a as j,y as r,o as S}from"../chunks/index.3eaemhlc.js";import{d as q}from"../chunks/singletons.URAtygLb.js";const A=()=>{const e=q;return{page:{subscribe:e.page.subscribe},navigating:{subscribe:e.navigating.subscribe},updated:e.updated}},D={subscribe(e){return A().page.subscribe(e)}};function K(e){let s,c,t,l,_,u=e[0].status+"",p,f,d=e[0].error?.message+"",m,v;return{c(){s=E("pre"),c=o("    "),t=E("code"),l=o(`
    (()__(()
